 ...
 */
final class Version20200427184842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, id_producto_id INT NOT NULL, id_usuario_id INT NOT NULL, puntuacion INT NOT NULL, comentario LONGTEXT NOT NULL, INDEX IDX_4B91E7026E57A479 (id_producto_id), INDEX IDX_4B91E7027EB2C349 (id_usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mensaje (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, apellido VARCHAR(100) NOT NULL, telefono INT NOT NULL, email VARCHAR(255) NOT NULL, mensaje LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, fecha_registro DATETIME NOT NULL, telefono INT NOT NULL, provincia VARCHAR(100) NOT NULL, direccion VARCHAR(255) NOT NULL, contrasenya VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
